...
| Metric | Target | Current |
|--------|--------|---------|
| Agent core MVP | ❌ | In development |
| First app live | ❌ | Not started |
| First B2B customer | ❌ | — |
| MRR target month 6 | €43K | — |
| MRR target month 12 | €112K | — |

### Strategy
- Use OpenClaw + GStack internally as workbench
- Build AgentJack as superior B2B alternative
- Agent core first → apps → surpass Garry's stack
- Dogfood everything
